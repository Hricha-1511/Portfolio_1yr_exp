...
import CV from './Hricha_Jaiswal_1yr_Exp.pdf'
...
export default function Hero() {
  return (
    ...
    A highly skilled Machine Learning Engineer bringing robust Python programming expertise and a deep understanding of machine learning algorithms.
    Experienced in developing innovative AI solutions, I have a strong background in text-to-SQL models, RAG, and
    automation workflows using FastAPI, Flask, PostgreSQL, make and n8n.
</p>
